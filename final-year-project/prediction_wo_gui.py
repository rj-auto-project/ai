...
model = load_model('/home/annone/ai/Sign-Language-To-Text-and-Speech-Conversion/cnn8grps_rad1_model.h5')
white = np.ones((400, 400), np.uint8) * 255
cv2.imwrite("/home/annone/ai/Sign-Language-To-Text-and-Speech-Conversion/white.jpg", white)
...
while True:
    try:
        ...
        if hands:
            ...
            white = cv2.imread("/home/annone/ai/Sign-Language-To-Text-and-Speech-Conversion/white.jpg")
            ...
            if handz:
                ...
                cv2.imwrite("/home/annone/ai/Sign-Language-To-Text-and-Speech-Conversion/test.jpg",white)
