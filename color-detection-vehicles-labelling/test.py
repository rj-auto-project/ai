...
image = opencv.imread("/home/annone/ai-camera/bus.jpg")
index = ["color","color_name","hex","R","G","B"]
dataset = pandas.read_csv("/home/annone/ai-camera/color-detection-vehicles-labelling/dataset.csv", names=index, header=None)
clickstate = False
r=0
g=0
b=0
